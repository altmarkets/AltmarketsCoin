...
###   This script attempts to download the signature file SHA256SUMS.asc from Altmarkets.org
...
WORKINGDIR="/tmp/Altmarkets"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://Altmarkets.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://Altmarkets.org/bin/"
VERSIONPREFIX="Altmarkets-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'Altmarkets-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[Altmarkets-]<version>-[rc[0-9]] (example: Altmarkets-0.9.2-rc1)"
   echo "wget output:"
