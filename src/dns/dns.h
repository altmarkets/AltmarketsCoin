...
static const unsigned int NAME_REGISTRATION_DAILY_FEE = 1000000; // Current set to 0.3 ALTM per month or 3.65 ALTM per year.
...
bool GetNameCurrentAddress(const CNameVal& name, CAltmarketsAddress& address, std::string& error);
