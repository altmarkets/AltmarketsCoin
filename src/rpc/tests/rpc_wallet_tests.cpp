...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CAltmarketsAddress demoAddress = CAltmarketsAddress(CTxDestination(demoPubkey.GetID()));
    UniValue retValue;
    ...
    CAltmarketsAddress setaccountDemoAddress = CAltmarketsAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CAltmarketsAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CAltmarketsAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
