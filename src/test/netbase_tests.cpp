...
{
    BOOST_CHECK(TestSplitHost("www.Altmarkets.org", "www.Altmarkets.org", -1));
    BOOST_CHECK(TestSplitHost("[www.Altmarkets.org]", "www.Altmarkets.org", -1));
    BOOST_CHECK(TestSplitHost("www.Altmarkets.org:80", "www.Altmarkets.org", 80));
    BOOST_CHECK(TestSplitHost("[www.Altmarkets.org]:80", "www.Altmarkets.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:16662", "::ffff:127.0.0.1", 16662));
    BOOST_CHECK(TestSplitHost("[::]:16662", "::", 16662));
    BOOST_CHECK(TestSplitHost("::16662", "::16662", -1));
    BOOST_CHECK(TestSplitHost(":16662", "", 16662));
    BOOST_CHECK(TestSplitHost("[]:16662", "", 16662));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:16662", "127.0.0.1:16662"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:16662", "[::]:16662"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
