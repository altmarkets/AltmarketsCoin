...
#define BOOST_TEST_MODULE Altmarkets Test Suite

#include "test_Altmarkets.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_Altmarkets_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
