...
#ifndef Altmarkets_SERIALIZE_H
#define Altmarkets_SERIALIZE_H
...
enum
{
    ...
    // modifiers
    SER_POSMARKER       = (1 << 18),  // Altmarkets: for sending block headers with PoS marker, to allow headers-first syncronization
};
 ...
 * Thus, the byte Altmarkets a[] with length len, where all but the last byte
 ...
 * * No redundancy: every (infinite) byte Altmarkets corresponds to a list
 *   of encoded integers.
 * 
