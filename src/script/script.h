...
#ifndef Altmarkets_SCRIPT_SCRIPT_H
#define Altmarkets_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Altmarkets always counted CHECKMULTISIGs
...
#endif // Altmarkets_SCRIPT_SCRIPT_H
