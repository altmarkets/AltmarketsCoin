    ...
    model(0)
{
    ...
    // normal Altmarkets address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying Altmarkets address(es)
    ...
    ui->payTo->setValidator(0);  // Altmarkets: disable validator so that we can type names
}
