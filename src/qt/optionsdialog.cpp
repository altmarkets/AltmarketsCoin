    ...
    fProxyIpValid(true)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("Altmarkets-silver"), QVariant("silver"));
    ...
    ui->unit->setModel(new AltmarketsUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->AltmarketsAtStartup, OptionsModel::StartAtStartup);
