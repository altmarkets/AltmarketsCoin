...
bool Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/Altmarkets"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Altmarkets"),
     ...
     * override -datadir in the Altmarkets.conf file in the default data directory
     * (to be consistent with Altmarketsd behavior)
     */
