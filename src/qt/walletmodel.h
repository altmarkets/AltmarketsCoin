...
#ifndef Altmarkets_QT_WALLETMODEL_H
#define Altmarkets_QT_WALLETMODEL_H
...
/** Interface to Altmarkets wallet from Qt view code. */
...
public:
    ...
    bool isMine(const CAltmarketsAddress &address);
...
#endif // Altmarkets_QT_WALLETMODEL_H
