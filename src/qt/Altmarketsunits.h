...
#ifndef Altmarkets_QT_AltmarketsUNITS_H
#define Altmarkets_QT_AltmarketsUNITS_H
...
/** Altmarkets unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class AltmarketsUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit AltmarketsUnits(QObject *parent);

    /** Altmarkets units.
      @note Source: https://en.Altmarkets.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        ALTM,
...
typedef AltmarketsUnits::Unit AltmarketsUnit;

#endif // Altmarkets_QT_AltmarketsUNITS_H