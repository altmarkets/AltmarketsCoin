...
#include "config/Altmarkets-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatAltmarketsURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + AltmarketsUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatAltmarketsURI(info));
}
