...
{
    // Escape all lower control characters (some get overridden with smaller Altmarketss below)
...
static void outputEscape()
{
	printf(	"// Automatically generated file. Do not modify.\n"
		"#ifndef Altmarkets_UNIVALUE_UNIVALUE_ESCAPES_H\n"
		"#define Altmarkets_UNIVALUE_UNIVALUE_ESCAPES_H\n"
	...
	printf(	"};\n"
		"#endif // Altmarkets_UNIVALUE_UNIVALUE_ESCAPES_H\n");
}
