...
contains(Altmarkets_NEED_QT_PLUGINS, 1) {
    DEFINES += Altmarkets_NEED_QT_PLUGINS
...
# also add new translations to src/qt/Altmarkets.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/Altmarkets_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/Altmarkets.rc
...
windows:RC_FILE = src/qt/res/Altmarkets.rc
...
macx:ICON = src/qt/res/icons/Altmarkets.icns
macx:TARGET = "Altmarkets-Qt"
...
HEADERS += \
    ...
    src/script/sign.h \
    src/script/Altmarketsconsensus.h \
    ...
    src/qt/Altmarketsunits.h \
    src/qt/Altmarketsgui.h \
    src/qt/Altmarketsamountfield.h \
    src/qt/Altmarketsaddressvalidator.h \
...
SOURCES += \
    ...
    src/script/sign.cpp \
    src/script/Altmarketsconsensus.cpp \
    ...
    src/qt/Altmarketsgui.cpp \
    src/qt/Altmarketsamountfield.cpp \
    src/qt/Altmarketsaddressvalidator.cpp \
    src/qt/Altmarkets.cpp \
    src/qt/signverifymessagedialog.cpp \
    src/qt/sendcoinsentry.cpp \
    src/qt/Altmarketsstrings.cpp \
    src/qt/Altmarketsunits.cpp \
