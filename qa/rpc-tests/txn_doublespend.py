...
from test_framework import AltmarketsTestFramework
...
class TxnMallTest(AltmarketsTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 Altmarkets:
        ...
        # First: use raw transaction API to send 1210 Altmarkets to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 50Altmarkets for another
        ...
        # Node0's total balance should be starting balance, plus 100Altmarkets for 
