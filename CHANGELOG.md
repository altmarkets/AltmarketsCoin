...
* Update Icons for Altmarkets
* Update CHANGELOG


**Altmarkets v1.1.0.0**

* Fix Altmarkets.conf read on daemon first launch
...
* Open Altmarkets.conf via UI added
...
* minfee sending fix for Altmarkets Qt. 
...
* [RPC]add legacy json mode (enabled by default, enable unicode by adding -legacyrpc=0 to Altmarkets.conf).
...
* Add RPCConsole to AltmarketsGUI::closeEvent
